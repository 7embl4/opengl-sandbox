...
std::string SOURCE_DIR = std::filesystem::current_path().string() + "\\..\\..\\..\\";
...
int main()
{
    ...
    /* Load shader */
    shader basic_shader("F:\\dev\\opengl-sandbox\\res\\shaders\\basic.glsl");
    basic_shader.bind();
    ...
    /* Textures */
    texture tex(SOURCE_DIR + "res\\textures\\cat.png");
    tex.bind();
